...
export default function PageShell({ children }: { children: ReactNode }) {
  return (
    <>
      <header className="sticky top-0 z-[100] flex h-[72px] items-center border-b border-line bg-[rgba(7,8,10,0.92)] backdrop-blur-[14px]">
        <div className="mx-auto flex w-full max-w-[1180px] items-center justify-between px-6">
          <Link href="/" aria-label="Grow Medico — home" className="shrink-0">
            <Logo variant="mark" height={34} priority className="min-[480px]:hidden" />
